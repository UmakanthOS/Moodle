...
|Large size deployment (with high availability)| Supporting more than 2000 concurrent users. This deployment uses Azure Files Premium, Azure DB for MySQL (16 vCores) and redis cache, without other options like elastic search. |[![Deploy to Azure Minimally](http://azuredeploy.net/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2FMoodle%2Fmaster%2Fazuredeploy-large-ha.json)
| Maximum |This maximal deployment uses Azure Files Premium, Azure DB for MySQL, redis cache, elastic search (3 VMs), and pretty large storage sizes (both data disks and DB).|[![Deploy to Azure Maximally](http://azuredeploy.net/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2FMoodle%2Fmaster%2Fazuredeploy-maximal.json)
...
**File Storage** There are three options for file storage (moodledata) - Azure Files Premium, Gluster FS and NFS. Azure Files Premium offers the performance and reliability that Moodle requires. Gluster FS solution was the previous default and is available to install in the fully configurable option.  
